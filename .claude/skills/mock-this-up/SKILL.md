...
2. Source the visual language per `.claude/skills/shared/design-sourcing.md` — read the actual implementation of the section, then similar components.
...
4. Write a standalone HTML file with inline CSS at `docs/specs/<area>/mockups/<slug>.html`, with an HTML comment header linking to the relevant spec if one exists.
