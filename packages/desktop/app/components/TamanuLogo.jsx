...
import tamanuLogoHorizontal from '../assets/images/tamanu_logo_horizontal.svg';
...
export const TamanuLogoHorizontal = ({ size, height, className }) => (
  <LogoImage src={tamanuLogoHorizontal} size={size} height={height} className={className} />
);
