  ...
  return (
    ...
    >
      ...
      <LocalisedField
        name="imagingType"
        label={
          <TranslatedText stringId="general.localisedFields.imagingType.label" fallback="TODO" />
        }
        defaultLabel="Type"
        component={SelectField}
      ...
      {!isCompletedTable && (
        <LocalisedField
          name="priority"
          label={
            <TranslatedText stringId="general.localisedFields.priority.label" fallback="TODO" />
          }
