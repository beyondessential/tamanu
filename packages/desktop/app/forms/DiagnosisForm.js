...
export const DiagnosisForm = React.memo(({ isTriage = false, onCancel, onSave, diagnosis, icd10Suggester }) => {
  ...
  const certaintyOptions = (isTriage || (diagnosis && diagnosis.certainty === 'emergency'))
    ? diagnosisCertainty
