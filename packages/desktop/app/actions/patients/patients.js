...
export const createPatientIndexes = () => dispatch => {
  ...
  mainDB
    ...
    .then(result => dispatch(createPatientIndexesSuccess(result)))
    .catch(err => {
...
export const fetchAdmittedPatients = () => dispatch => {
  ...
  mainDB
    ...
    .then(filteredResult => dispatch(fetchAdmittedPatientsSuccess(filteredResult.docs)))
    .catch(err => {
...
export const fetchOnePatient = id => dispatch => {
  ...
  mainDB
    ...
    .then(filteredResult => dispatch(fetchOnePatientSuccess(filteredResult.docs[0])))
    .catch(err => {
      dispatch(fetchAdmittedPatientsFailed(err));
    });
};
