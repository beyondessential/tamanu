...
import {
  TextField, DateField, RadioField, UpdateButton, BackButton,
  FormRow, SelectField, Form, Field,
} from '../../../components';
import {
          ...
          <Grid container spacing={24} direction="row">
            ...
            <FormRow>
              <Field
                ...
                label="Date Of Birth"
                name="dateOfBirth"
                helperText={values.dateOfBirth && `${getDifferenceDate(moment(), values.dateOfBirth)} of age`}
              />
              <Field
                component={DateField}
                label="Referred Date"
