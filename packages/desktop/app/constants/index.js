...
export const PDF_DOCUMENT_TYPES = [DOCUMENT_TYPES.PATIENT_LETTER, DOCUMENT_TYPES.RAW_PDF];

export const DOCUMENT_TYPE_LABELS = {
  [DOCUMENT_TYPES.PATIENT_LETTER]: 'Patient Letter',
  [DOCUMENT_TYPES.RAW_PDF]: 'PDF',
  [DOCUMENT_TYPES.RAW_JPEG]: 'JPEG',
};
