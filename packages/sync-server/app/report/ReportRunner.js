...
export class ReportRunner {
  constructor(reportName, parameters, recipients, context, emailService) {
  ...
  async run() {
    ...
    try {
      ...
      reportData = await reportDataGenerator(this.context, this.parameters, this.tupaiaApiClient);
