...
export class SurveyResponseHandler extends BasicHandler {
  models = null;

  constructor(models) {
    super(models.SurveyResponse);
    this.models = models;
  }
