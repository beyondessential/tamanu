...
export const LabTestPanelLabTestTypes = yup.object().shape({
  // id is generated by loader so this schema does not extend Base
  labTestPanelId: yup.string().required(),
  labTestTypeId: yup.string().required(),
});

export const LabTestSuperset = Base.shape({
  name: yup.string().required(),
  code: yup.string().required(),
  visibilityStatus,
});

export const LabTestSupersetLabTestPanels = yup.object().shape({
  // id is generated by loader so this schema does not extend Base
  labTestSupersetId: yup.string().required(),
  labTestPanelId: yup.string().required(),
});
