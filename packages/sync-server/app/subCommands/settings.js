...
export async function initSettings({ preview }) {
  ...
  return `Successfully loaded ${res[1]} settings from config/default.json`;
}
...
export const settingsCommand = new Command('settings')
  ...
  .addCommand(
    new Command('init')
      .description('initialize settings from config files')
      .option('--preview', 'Print the settings that will be initialized')
      .action(async (...args) =>
