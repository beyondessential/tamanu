...
describe('FHIR integration - Patient', () => {
  ...
  describe('success', () => {
    it('fetches a patient', async () => {
      ...
      const path = `/v1/integration/fhir/Patient?_sort=-issued&_page=0&_count=2&status=final&subject%3Aidentifier=${id}`;
    ...
    it('returns a list of patients when passed no query params', async () => {
      ...
      const path = `/v1/integration/fhir/Patient`;
  ...
  describe('failure', () => {
    it('returns a 422 error when passed the wrong query params', async () => {
      ...
      const path = `/v1/integration/fhir/Patient?_sort=id&_page=z&_count=x&status=initial&subject%3Aidentifier=${id}`;
