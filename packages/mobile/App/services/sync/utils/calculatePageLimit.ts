...
export const OPTIMAL_TIME_PER_PAGE = 10000; // aim for 2 seconds per page
const MAX_LIMIT_CHANGE_PER_PAGE = 0.3; // max 20% increase from batch to batch, or it is too jumpy
