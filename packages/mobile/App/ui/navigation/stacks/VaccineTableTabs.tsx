...
import { VaccineFormRefreshProvider } from '~/ui/components/Forms/VaccineForms/VaccineRefreshContext';
      ...
      >
        ...
        <Tabs.Screen
          options={{
            title: () => (
              <TranslatedText
                stringId="vaccine.form.category.option.campaign"
                fallback="Campaign"
              />
            ),
          }}
