...
export const TakenNotOnTime = React.memo((props: IconWithSizeProps) => (
  <StyledView height={props.size} width={props.size}>
    <Svg width="100%" height="100%" viewBox="0 0 34 34" {...props}>
      <Circle
        cx="17"
        cy="17"
        r="16"
        ...
        stroke-width="2"
      />
      <Circle cx="17" cy="17" r="17" fill={props.background || '#FF7A00'} />
      <Path
