...
export const VaccineStatusCells: VaccineStatusCellsType = {
  ...
  [VaccineStatus.SCHEDULED]: {
    Icon: Icons.EmptyCircleIcon,
    background: ColorHelper.halfTransparency(theme.colors.INDIGO),
    color: theme.colors.INDIGO,
    text: 'Scheduled',
  },
  [VaccineStatus.MISSED]: {
    Icon: Icons.CrossIcon,
    background: ColorHelper.halfTransparency(theme.colors.ALERT),
    color: theme.colors.ALERT,
    text: 'Missed',
  },
  [VaccineStatus.DUE]: {
    Icon: Icons.EmptyCircleIcon,
    background: ColorHelper.halfTransparency(theme.colors.GREEN),
    color: theme.colors.GREEN,
    text: 'Due now',
  },
  [VaccineStatus.OVERDUE]: {
    Icon: Icons.EmptyCircleIcon,
    background: ColorHelper.halfTransparency(theme.colors.ORANGE),
    color: theme.colors.ORANGE,
    text: 'Overdue',
  },
  [VaccineStatus.UPCOMING]: {
    Icon: Icons.EmptyCircleIcon,
    background: ColorHelper.halfTransparency(theme.colors.BLUE),
