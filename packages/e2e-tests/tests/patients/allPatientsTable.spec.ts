...
test.describe('All patient table search', () => {
  ...
  test('Search for deceased patient including NHN', async ({
    newPatient,
    allPatientsPage,
    api,
  }) => {
...
test.describe('All patient table pagination', () => {
  ...
  test('change number of patient per list to 25 and going to next page', async ({
    allPatientsPage,
  }) => {
    await expect(allPatientsPage.patientTable.pageRecordCountDropDown).toHaveText('10');
  ...
  test.skip('change number of patient per list to 50 and going to next page', async ({
    allPatientsPage,
  }) => {
    await expect(allPatientsPage.patientTable.pageRecordCountDropDown).toHaveText('10');
    await allPatientsPage.patientTable.pageRecordCountDropDown.click();
