...
test.describe('Procedures', () => {
  test('[T-0197][AT-0089]Validate pre-populated fields', async ({ currentUser, patientOnProceduresTab: { patientDetailsPage } }) => {
  ...
  test('[T-0197][AT-0090]Add a procedure with all fields filled and validate the procedure table', async ({ patientOnProceduresTab: { patientDetailsPage } }) => {
    await patientDetailsPage.patientProcedurePane?.newProcedureButton.click();
    const modal = patientDetailsPage.patientProcedurePane!.getNewProcedureModal();
  ...
  test('[T-0197][AT-0091]Add a procedure with only required fields and validate the procedure table', async ({ patientOnProceduresTab: { patientDetailsPage } }) => {
    await patientDetailsPage.patientProcedurePane?.newProcedureButton.click();
    const modal = patientDetailsPage.patientProcedurePane!.getNewProcedureModal();
  ...
  test('[T-0197][AT-0092]Add multiple procedures and validate the procedure table', async ({ patientOnProceduresTab: { patientDetailsPage } }) => {
  ...
  test('[AT-0093]Add procedure and view procedure record', async ({ patientOnProceduresTab: { patientDetailsPage } }) => {
    await patientDetailsPage.patientProcedurePane?.newProcedureButton.click();
    const modal = patientDetailsPage.patientProcedurePane!.getNewProcedureModal();
    const procedureData = await modal.fillAllFields();
    await modal.saveProcedureButton.click();
  ...
  test('[AT-0094]Discard procedure creation', async ({ patientOnProceduresTab: { patientDetailsPage } }) => {
    await patientDetailsPage.patientProcedurePane?.newProcedureButton.click();
    const modal = patientDetailsPage.patientProcedurePane!.getNewProcedureModal();
    await modal.waitForModalToLoad();
  ...
  test('[AT-0095]Continue editing while cancelling procedure creation', async ({ patientOnProceduresTab: { patientDetailsPage } }) => {
    await patientDetailsPage.patientProcedurePane?.newProcedureButton.click();
    const modal = patientDetailsPage.patientProcedurePane!.getNewProcedureModal();
    await modal.waitForModalToLoad();
   const procedureData = await modal.fillAllFields();
