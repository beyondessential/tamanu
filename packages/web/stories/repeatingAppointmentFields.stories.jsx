...
import { RepeatingAppointmentFields } from '../app/components/Appointments/OutpatientsBookingForm/RepeatingAppointmentFields';
import Box from '@mui/material/Box';
import { Colors } from '../app/constants';
import { DateInput } from '../app/components';

export default {
  title: 'Scheduling/RepeatingAppointmentFields',
  component: RepeatingAppointmentFields,
};
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <Box width="312px" backgroundColor={Colors.background}>
        <RepeatingAppointmentFields {...args} value={value} onChange={handleChange} />
      </Box>
