...
const FacilitySelectionFormComponent = ({ options, errorMessage, onCancel }) => {
  return (
    <FormGrid columns={1}>
      ...
      <Field
        name="facilityId"
        label={<TranslatedText stringId="general.localisedField.facility.label" fallback="Facility" />}
      ...
      <StyledButtonRow>
        ...
        <SubmitButton text={<TranslatedText stringId="general.action.submit" fallback="Submit" />} />
      </StyledButtonRow>
      <LanguageSelector />
    </FormGrid>
  );
      ...
      <Form
        ...
        validationSchema={yup.object().shape({
          facilityId: yup
            .string()
            .required()
            .translatedLabel(<TranslatedText stringId="general.localisedField.facility.label" fallback="Facility" />),
        })}
      />
    );
  },
