  ...
  return (
    <TwoTwoGrid data-testid='twotwogrid-2swz'>
      ...
      {!editMode && schedules?.length ? (
        <AdministeredVaccineScheduleField schedules={schedules} data-testid='administeredvaccineschedulefield-cjfr' />
      ) : null}
      <VaccineDateField
      ...
      {values.givenElsewhere ? <GivenByCountryField data-testid='givenbycountryfield-oyam' /> : <GivenByField data-testid='givenbyfield-ekoq' />}
