    ...
    birthCertificate: {
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-yihy' />
      ),
    },
    insurerId: {
      ...
      label: (
        <TranslatedText
          ...
          fallback="Insurer"
          data-test-id='translatedtext-kq3u' />
      ),
    ...
    insurerPolicyNumber: {
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-govk' />
      ),
      condition: () => !!enablePatientInsurer,
    },
    drivingLicense: {
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-b397' />
      ),
    },
    passport: {
      component: TextField,
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-bl6j' />
      ),
    },
  };
