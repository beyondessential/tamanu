  ...
  const PERSONAL_FIELDS = {
    title: {
      ...
      label: <TranslatedText
        ...
        fallback="Title"
        data-test-id='translatedtext-6i2v' />,
    },
    maritalStatus: {
      component: TranslatedSelectField,
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-7fsl' />
      ),
    },
    bloodType: {
      component: TranslatedSelectField,
      ...
      label: (
        <TranslatedText
          ...
          fallback="Blood type"
          data-test-id='translatedtext-xtyz' />
      ),
    },
    placeOfBirth: {
      component: TextField,
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-648h' />
      ),
    },
    countryOfBirthId: {
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-kdl1' />
      ),
    },
    nationalityId: {
      component: AutocompleteField,
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-hy5h' />
      ),
    },
    ethnicityId: {
      component: AutocompleteField,
      ...
      label: (
        <TranslatedText
          ...
          fallback="Ethnicity"
          data-test-id='translatedtext-06tk' />
      ),
    },
    religionId: {
      component: AutocompleteField,
      ...
      label: (
        <TranslatedText
          ...
          fallback="Religion"
          data-test-id='translatedtext-3si2' />
      ),
    },
    educationalLevel: {
      component: TranslatedSelectField,
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-6j9w' />
      ),
    },
    occupationId: {
      component: AutocompleteField,
      ...
      label: (
        <TranslatedText
          ...
          fallback="Occupation"
          data-test-id='translatedtext-q6cf' />
      ),
    },
    socialMedia: {
      component: TranslatedSelectField,
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-jbsu' />
      ),
    },
    patientBillingTypeId: {
      ...
      label: (
        <TranslatedText
          ...
          data-test-id='translatedtext-9y03' />
      ),
    },
    motherId: {
      component: AutocompleteField,
      ...
      label: <TranslatedText
        ...
        fallback="Mother"
        data-test-id='translatedtext-kaiy' />,
    },
    fatherId: {
      component: AutocompleteField,
      suggester: patientSuggester,
      label: <TranslatedText
        ...
        fallback="Father"
        data-test-id='translatedtext-1vec' />,
    },
  };
