    ...
    return (
        <>
            ...
            >
                ...
                <ModalBackCancelConfirmRow onBack={handleBackAddReminder} confirmText="Confirm & connect" confirmColor="primary"
                    onConfirm={handleConfirmConnect} onCancel={handleCloseAddReminder} />
            </BaseModal>
            <AddReminderQrCodeModal openReminderQrCodeModal={openReminderQrCodeModal} patient={patient}
