...
import { TranslatedEnum, TranslatedReferenceData, TranslatedText } from '../..'; // Assuming TranslatedText is in components/index
...
// TODO: Replace placeholder data with actual props
export const MarInfoPane = ({ medication, marInfo }) => {
  const date = '22 October 2024';
              ...
              {isAutoGenerated ? (
                <LowerText>
                  <TranslatedText
                    ...
                    replacements={{ dueAt: format(new Date(dueAt), 'ha') }}
                  />
                </LowerText>
              ) : (
                <TranslatedText
