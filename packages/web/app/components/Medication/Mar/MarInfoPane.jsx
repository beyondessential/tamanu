...
import { useTimeSlotDisplay } from '../../../utils/medications';
import { TranslatedText, TranslatedReferenceData, DateDisplay, useDateTimeFormat } from '@tamanu/ui-components';
...
export const MarInfoPane = ({ medication, marInfo }) => {
  ...
  const timeSlotDisplay = useTimeSlotDisplay(dueAt);
  const { formatTimeSlot } = useDateTimeFormat();
              ...
              <span>
                ...
                {isAutoGenerated ? (
                  <TranslatedText
                    ...
                    replacements={{ dueAt: timeSlotDisplay }}
                  />
                ) : (
                  <TranslatedText
