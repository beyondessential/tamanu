...
const VACCINE_FIELD_CATEGORY_OPTIONS = [
  ...
  },
  {
    ...
    leftOptionalElement: <VerticalDivider orientation="vertical" data-testid='verticaldivider-n0cy' />,
...
export const AdministeredVaccineScheduleField = ({ schedules }) => {
  ...
  return (scheduleOptions.length > 0 && (<FullWidthCol data-testid='fullwidthcol-3xje'>
    <Field
  ...
  <FormSubmitCancelRow
    ...
    confirmText={
      editMode ? <TranslatedText
        ...
        fallback="Save"
        data-testid='translatedtext-xb1i' /> : undefined
    }
