  ...
  return (
    <ConfirmModal
      ...
      cancelButtonText={<TranslatedText
        ...
        fallback="No"
        data-test-id='translatedtext-mp4x' />}
      confirmButtonText={<TranslatedText
        stringId="general.action.yes"
        fallback="Yes"
        data-test-id='translatedtext-gmni' />}
    />
  );
};
