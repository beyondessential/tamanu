          ...
          {note.onBehalfOf && note.onBehalfOf.displayName ? (
            <NoteOnBehalfOf>
              ...
              <TranslatedText
                ...
                data-test-id='translatedtext-blqt' />
            </NoteOnBehalfOf>
          ) : null}
          {isMainCarePlan ? (
            <MainCarePlanIndicator>
              <TranslatedText
                ...
                data-test-id='translatedtext-goik' />
            </MainCarePlanIndicator>
          ) : null}
        </VerticalCenter>
        <VerticalCenter>
          <Timestamp>
            <DateDisplay date={note.date} data-test-id='datedisplay-ega2' />
          </Timestamp>
          <MenuButton
            ...
            actions={[
              {
                label: <TranslatedText
                  ...
                  fallback="Edit"
                  data-test-id='translatedtext-p2m2' />,
                action: () => {
                  onEditClicked();
                },
              },
                ...
                : [
                    {
                      label: <TranslatedText
                        ...
                        fallback="Delete"
                        data-test-id='translatedtext-bq8n' />,
                      action: async () => {
