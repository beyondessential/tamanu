...
const UneditedActions = ({ onClose, onDelete }) => (
  <ModalGenericButtonRow data-testid='modalgenericbuttonrow-wtwk'>
    <DeleteButton onClick={onDelete} data-testid='deletebutton-wijz'>Delete template</DeleteButton>
    <Gap data-testid='gap-4ju1' />
    <Button onClick={onClose} data-testid='button-9i89'>Close</Button>
  </ModalGenericButtonRow>
);

const EditedActions = ({ onClose, onDelete, onSave }) => (
  <ModalGenericButtonRow data-testid='modalgenericbuttonrow-946p'>
    <DeleteButton onClick={onDelete} data-testid='deletebutton-bd75'>Delete template</DeleteButton>
    <Gap data-testid='gap-0nns' />
    <OutlinedButton onClick={onClose} data-testid='outlinedbutton-j2h3'>Cancel</OutlinedButton>
    <Button onClick={onSave} data-testid='button-g2un'>Save</Button>
  </ModalGenericButtonRow>
);
    ...
    const renderForm = ({ submitForm, dirty, values }) => (
      <>
        ...
        {dirty ? (
          ...
          <UneditedActions onDelete={onDelete} onClose={onClose} data-testid='uneditedactions-wyml' />
        )}
      </>
    );
