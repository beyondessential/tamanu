...
export const EditorView = memo(
  ({
    ...
    const initialSettings = initialValues?.settings ?? initialValuesRef?.current?.settings ?? {};
    const getInitialSettingValue = path => get(initialSettings, getSettingPath(path));
