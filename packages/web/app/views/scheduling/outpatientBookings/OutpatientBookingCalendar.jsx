      ...
      onSuccess: () =>
        toast.success(
          <TranslatedText
            ...
            data-test-id='translatedtext-zrh7' />,
        ),
      onError: () =>
        toast.error(
          <TranslatedText
            ...
            data-test-id='translatedtext-uv2o' />,
        ),
    },
  );
    ...
    return (
      <ErrorText>
        <TranslatedText
          ...
          data-test-id='translatedtext-nizo' />
      </ErrorText>
    );
  }
    ...
    return (
      <StatusText>
        <TranslatedText
          ...
          data-test-id='translatedtext-49j9' />
      </StatusText>
    );
  }
    ...
    >
        ...
        const title =
          groupBy === APPOINTMENT_GROUP_BY.LOCATION_GROUP ? (
            <TranslatedReferenceData
              ...
              value={cell.id}
              fallback={cell.name}
              data-test-id='translatedreferencedata-qqdd' />
          ) : (
            cell.displayName
          );
        return (
                      ...
                      ? [
                          {
                            label: (
                              <TranslatedText
                                ...
                                data-test-id='translatedtext-rjm7' />
                            ),
                          ...
                          },
                          {
                            label: (
                              <TranslatedText
                                ...
                                data-test-id='translatedtext-amm4' />
                            ),
                            action: () =>
      ...
      <FormModal
        title={<TranslatedText
          ...
          data-test-id='translatedtext-6kqx' />}
