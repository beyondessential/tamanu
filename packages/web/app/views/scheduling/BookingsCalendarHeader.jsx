...
const thisWeekId = 'bookings-calendar__this-week';
const firstDisplayedDayId = 'bookings-calendar__beginning';
...
export const BookingsCalendarHeader = ({ selectedMonthState, displayedDates }) => {
