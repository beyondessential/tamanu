...
export const LabRequestSampleDetailsModal = ({ open, onClose, labRequest }) => {
  return (
    <Modal
      ...
      <LabRequestSampleDetailsCard labRequest={labRequest} data-testid='labrequestsampledetailscard-ev5m' />
      <Box display="flex" justifyContent="flex-end" pt={3} data-testid='box-l50g'>
        <Button onClick={onClose} data-testid='button-ugal'>Close</Button>
      </Box>
    </Modal>
  );
};
