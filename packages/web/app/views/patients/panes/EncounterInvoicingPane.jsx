              ...
              <InvoiceHeading>
                <InvoiceTitle>
                  <TranslatedText
                    ...
                    data-test-id='translatedtext-p1ag' />
                  {`: ${invoice.displayId}`}
                </InvoiceTitle>
              ...
              {(cancelable || deletable) && (
                <ActionsPane>
                    ...
                    items={[
                      {
                        label: (
                          <TranslatedText
                            ...
                            data-test-id='translatedtext-e8px' />
                        ),
                      ...
                      },
                      {
                        label: (
                          <TranslatedText
                            ...
                            data-test-id='translatedtext-u80n' />
                        ),
                  ...
                  <Button
                    ...
                    data-test-id='button-5wza'>
                    <TranslatedText
                      stringId="invoice.action.edit"
                      fallback="Edit invoice"
                      data-test-id='translatedtext-4o6c' />
                  </Button>
                </ActionsPane>
              )}
            </InvoiceTopBar>
        ...
        <EmptyPane>
          {ability.can('create', 'Invoice') && (
            <Button
              ...
              data-test-id='button-5fke'>
              <TranslatedText
                stringId="invoice.action.create"
                fallback="Create invoice"
                data-test-id='translatedtext-v4ik' />
            </Button>
          )}
        </EmptyPane>
      )}
