      ...
      render={({ values }) => {
        ...
        return (
          <>
            ...
            <ImagingResultsSection results={imagingRequest.results} data-testid='imagingresultssection-5wyc' />
            <h4>
...
export const ImagingRequestView = () => {
  ...
  if (patient.loading || imagingRequest.loading) return <LoadingIndicator data-testid='loadingindicator-31bz' />;
