...
const DateCell = React.memo(({ value }) => <DateDisplay date={value} data-testid='datedisplay-bd7t' />);
export const SexCell = React.memo(({ value }) => <TranslatedSex sex={value} data-testid='translatedsex-1r4y' />);
const SyncedCell = React.memo(({ value }) =>
  value === true ? <CloudDone color="primary" data-testid='clouddone-zrop' /> : <CloudOff color="primary" data-testid='cloudoff-anvf' />,
);
