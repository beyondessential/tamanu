    ...
    return [
      {
        ...
        title: <TranslatedText
          ...
          fallback="Status"
          data-test-id='translatedtext-zgga' />,
        sortable: false,
        accessor: row => {
      ...
      },
      {
        ...
        title: (
          <TranslatedText
            ...
            data-test-id='translatedtext-nzc5' />
        ),
        sortable: false,
      ...
      },
      {
        ...
        title: (
          <TranslatedText
            ...
            data-test-id='translatedtext-x3v2' />
        ),
        sortable: true,
        accessor: row => <DateDisplay date={row.date} data-test-id='datedisplay-78fu' />,
      },
      ...(removedOnce
        ? [
            {
              ...
              title: (
                <TranslatedText
                  ...
                  data-test-id='translatedtext-zh5o' />
              ),
              sortable: false,
              accessor: row => <DateDisplay date={row?.registrationDate} data-test-id='datedisplay-pf2l' />,
            },
          ]
        : []),
    ];
    ...
    <Container fullWidth={programRegistryConditions?.length === 0}>
      <Heading5 style={{ marginBottom: '13px' }}>
        <TranslatedText
          ...
          data-test-id='translatedtext-725p' />
      </Heading5>
      <Table
        isBodyScrollable
        initialSort={{
        ...
        noDataMessage={
          <TranslatedText
            ...
            data-test-id='translatedtext-1gvn' />
        }
        elevated={false}
        isLoading={isLoading}
