...
const importers = {
  ...
  medicalareas: referenceDataImporter('medicalArea'),
  nursingzones: referenceDataImporter('nursingZone'),
  settlements: referenceDataImporter('settlement'),
  occupations: referenceDataImporter('occupation'),
  users: userImporter,
