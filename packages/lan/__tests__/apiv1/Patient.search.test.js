...
const searchTestPatients = [
  ...
  { displayId: 'search-by-display-id', firstName: 'ignored-name', lastName: 'ignored-name' },
  { displayId: 'search-by-secondary-id', secondaryIds: ['patient-secondary-id'], firstName: 'ignored-name', lastName: 'ignored-name' },
  {
  ...
  { firstName: 'search-by-name', lastName: 'ignored-name' },
  { firstName: 'search-by-name', lastName: 'ignored-name' },
  { firstName: 'search-by-age-OLD', lastName: 'ignored-name', dateOfBirth: yearsAgo(50) },
  { firstName: 'search-by-age-OLD', lastName: 'ignored-name', dateOfBirth: yearsAgo(35) },
  ...
  { firstName: 'search-by-age-YOUNG', lastName: 'ignored-name', dateOfBirth: yearsAgo(15) },
  { firstName: 'search-by-age-YOUNG', lastName: 'ignored-name', dateOfBirth: yearsAgo(1) },
  { firstName: 'search-by-village', lastName: 'ignored-name', villageIndex: 0 },
  { firstName: 'search-outpatient', lastName: 'ignored-name', encounters: [{ encounterType: 'clinic', current: true }] },
  { firstName: 'search-outpatient', lastName: 'ignored-name', encounters: [{ encounterType: 'clinic', current: true }] },
  { firstName: 'search-outpatient', lastName: 'ignored-name', encounters: [{ encounterType: 'clinic', current: true }] },
  { firstName: 'search-inpatient', lastName: 'ignored-name', encounters: [{ encounterType: 'admission', current: true }] },
  { firstName: 'search-inpatient', lastName: 'ignored-name', encounters: [{ encounterType: 'admission', current: true }] },
  { firstName: 'search-encounter-OUT', lastName: 'ignored-name', encounters: [{ encounterType: 'clinic' }] },
  { firstName: 'search-encounter-OUT', lastName: 'ignored-name', encounters: [{ encounterType: 'emergency' }] },
  { firstName: 'search-encounter-OUT', lastName: 'ignored-name', encounters: [{ encounterType: 'admission' }] },
  { firstName: 'search-by-location', lastName: 'ignored-name', encounters: [{ locationIndex: 0 }] },
  { firstName: 'search-by-location-group', lastName: 'ignored-name', encounters: [{ locationIndex: 0 }] },
  { firstName: 'search-by-department', lastName: 'ignored-name', encounters: [{ departmentIndex: 0 }] },
