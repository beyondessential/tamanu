...
describe('Assistive technology device line list', () => {
  ...
  beforeAll(async () => {
    ...
    await app.post('/v1/surveyResponse').send({
      ...
      startTime: '2021-03-12 10:50:28.133',
      patientId: expectedPatient1.id,
      endTime: '2021-03-12 10:53:15.708',
      answers: {
    ...
    await app.post('/v1/surveyResponse').send({
      surveyId: REGISTRATION_FORM_SURVEY_ID,
      startTime: '2021-03-15 10:50:28.133',
      patientId: expectedPatient1.id,
      endTime: '2021-03-15 10:53:15.708',
      answers: {
    ...
    await app.post('/v1/surveyResponse').send({
      ...
      startTime: '2021-03-17 10:50:28.133',
      patientId: expectedPatient1.id,
      endTime: '2021-03-17 10:53:15.708',
      answers: {
    ...
    await app.post('/v1/surveyResponse').send({
      surveyId: MOBILITY_SURVEY_ID,
      startTime: '2021-03-17 11:50:28.133',
      patientId: expectedPatient1.id,
      endTime: '2021-03-17 11:53:15.708',
      answers: {
    ...
    await app.post('/v1/surveyResponse').send({
      surveyId: MOBILITY_SURVEY_ID,
      startTime: '2021-03-20 10:50:28.133',
      patientId: expectedPatient1.id,
      endTime: '2021-03-20 10:53:15.708',
      answers: {
    ...
    await app.post('/v1/surveyResponse').send({
      surveyId: MOBILITY_SURVEY_ID,
      startTime: '2021-03-20 11:50:28.133',
      patientId: expectedPatient1.id,
      endTime: '2021-03-20 11:53:15.708',
      answers: {
