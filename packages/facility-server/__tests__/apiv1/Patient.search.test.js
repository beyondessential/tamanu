...
describe('Patient search', () => {
  ...
  it('should error if user has insufficient permissions', async () => {
    const response = await baseApp.get(`/api/patient?markedForSyncFacility=${facilityId}`).query({
  ...
  it('should not error if there are no results', async () => {
    const response = await app.get(`/api/patient?markedForSyncFacility=${facilityId}`).query({
      displayId: 'really-shouldnt-show-up',
    });
  ...
  describe('Sorting', () => {
    ...
    it('should sort by surname by default', async () => {
      const response = await app.get(`/api/patient?markedForSyncFacility=${facilityId}`);
