    ...
    SELECT
      ...
      ARRAY_AGG((
        JSONB_BUILD_OBJECT(
          ...
          -- logged_at is a real UTC instant; render it in the primary timezone so it
          -- matches the naive date_time_string convention the rest of the chart data
          -- (and the frontend's local-time formatting) expects.
