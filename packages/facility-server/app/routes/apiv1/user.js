                  ...
                  Sequelize.literal(`
                    EXISTS (
                      ...
                      WHERE ep.encounter_id = "Task"."encounter_id"
                        ...
                        -- Check if MAR is not currently paused using LATERAL join for better performance
                        ...
                        AND EXISTS (
                          SELECT 1
                          FROM LATERAL get_medication_time_slot(mar.due_at::timestamp) AS mar_time_slot
                          WHERE (
