...
surveyResponse.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const { facilityId, ...responseData } = body;
    ...
    const updatedBody = {
      locationId: responseData.locationId || (await getDefaultId('location')),
      departmentId: responseData.departmentId || (await getDefaultId('department')),
      userId: req.user.id,
      ...responseData,
    };
