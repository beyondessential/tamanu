...
export const translationFactory = translations => (stringId, fallback, replacements) =>
  translate(translations[stringId], fallback, replacements);

export const translate = (text, fallback, replacements) => {
  if (text) return replaceStringVariables(text, replacements);
