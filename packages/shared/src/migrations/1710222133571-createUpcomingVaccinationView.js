...
select 
	distinct on (fsv2.vaccine_id)
	fp.patient_id,
	fsv2.scheduled_vaccine_id,
	fsv2.vaccine_id,
	fsv2.weeks_from_last_vaccination_due * 7 + fav.administered_date
...
order by fsv2.vaccine_id, fsv2.index
),
patient_vaccine_schedule as (
	select * from patient_vaccine_fixed_schedule
	union all
	select * from patient_vaccine_dynamic_schedule
)
SELECT
	*,
