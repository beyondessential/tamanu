export async function up(query) {
  ...
  await query.sequelize.query(
    'ALTER TRIGGER set_lab_test_panels_updated_at_sync_tick on lab_test_panels RENAME TO lab_panels_updated_at_sync_tick;',
  );
  ...
  await query.sequelize.query(
    'ALTER TRIGGER set_lab_test_panel_lab_test_types_updated_at_sync_tick on lab_test_panel_lab_test_types RENAME TO lab_panel_lab_test_types_updated_at_sync_tick;',
  );
  await query.sequelize.query(
  ...
  await query.sequelize.query(
    'ALTER TRIGGER set_lab_test_panel_requests_updated_at_sync_tick on lab_test_panel_requests RENAME TO lab_panel_request_updated_at_sync_tick;',
  );
  await query.sequelize.query(
...
export async function down(query) {
  ...
  await query.sequelize.query(
    'ALTER TRIGGER set_lab_panel_request_updated_at_sync_tick on lab_panel_requests RENAME TO lab_test_panel_requests_updated_at_sync_tick;',
  );
  await query.sequelize.query(
  ...
  await query.sequelize.query(
    'ALTER TRIGGER set_lab_panel_lab_test_types_updated_at_sync_tick on lab_panel_lab_test_types RENAME TO lab_test_panel_lab_test_types_updated_at_sync_tick;',
  );
  await query.sequelize.query(
  ...
  await query.sequelize.query(
    'ALTER TRIGGER set_lab_panels_updated_at_sync_tick on RENAME TO lab_test_panels_updated_at_sync_tick;',
  );
