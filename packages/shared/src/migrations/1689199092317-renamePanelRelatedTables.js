export async function up(query) {
  ...
  ); // will be automatically added with the correct name by post-migration step
  await query.sequelize.query(
  ...
  ); // will be automatically added again by post-migration step
  await query.sequelize.query(
  ...
  // lab_test_panel_requests -> lab_panel_requests
  await query.sequelize.query(
...
export async function down(query) {
  // lab_panel_requests -> lab_test_panel_requests
  ...
  // lab_panel_lab_test_types -> lab_test_panel_lab_test_types
