...
export async function finishWebAuthnRegistration({
  ...
  if (!challenge) {
    throw new InvalidTokenError('Unknown, used, or expired registration challenge');
  }
  ...
  try {
    ...
    throw new InvalidCredentialError(`Passkey registration could not be verified: ${err.message}`);
  }
  if (!verification.verified) {
    throw new InvalidCredentialError('Passkey registration could not be verified');
  }
