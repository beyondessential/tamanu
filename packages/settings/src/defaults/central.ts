export const centralDefaults = {
  ...
  integrations: {
    ...
    signer: {
      enabled: false,
      // For VDS-NC: exactly 2 uppercase letters/numbers,
      // must be unique in country, ref 9303-13 §2.2.1(a)
  ...
  sync: {
    ...
    // can be turned on by lowering to some amount that seems appropriate if snapshot
