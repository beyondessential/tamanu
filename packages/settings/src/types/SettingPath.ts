...
type StartsWith<T extends string, U extends string> = T extends `${U}${Subscript<string>}`
  ? T
  : never;
...
export type FrontEndExposedSettingPath = StartsWith<
  FacilitySettingPath,
  (typeof KEYS_EXPOSED_TO_FRONT_END)[number]
>;
