...
describe('snapshotOutgoingChanges', () => {
  ...
  it(
    ...
    withErrorShown(async () => {
      ...
      const tock = await LocalSystemFact.incrementValue(FACT_CURRENT_SYNC_TIME, 2);
  ...
  it(
    ...
    withErrorShown(async () => {
      const { SyncSession, LocalSystemFact, ReferenceData } = models;
      await LocalSystemFact.incrementValue(FACT_CURRENT_SYNC_TIME, 2);
      await ReferenceData.create(fakeReferenceData());
  ...
  it(
    ...
    withErrorShown(async () => {
      const { SyncSession, LocalSystemFact, ReferenceData } = models;
      const firstTock = await LocalSystemFact.incrementValue(FACT_CURRENT_SYNC_TIME, 2);
      await ReferenceData.create(fakeReferenceData());
  ...
  describe('syncAllLabRequests', () => {
    const setupTestData = async () => {
      ...
      const secondTock = await LocalSystemFact.incrementValue(FACT_CURRENT_SYNC_TIME, 2);
