...
export const seedLocations = async (models, facilityIdParam) => {
  const facilityId = facilityIdParam || (await randomRecordId(models, 'Facility'));
...
export const seedLocationGroups = async (models, facilityIdParam) => {
  const facilityId = facilityIdParam || (await randomRecordId(models, 'Facility'));
