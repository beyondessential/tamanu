...
import { COLORS, ColorFn } from './color';
import { log } from './log';
...
function httpFormatter(tokens: morgan.TokenIndexer<IncomingMessage, ServerResponse>, req: IncomingMessage, res: ServerResponse): string {
