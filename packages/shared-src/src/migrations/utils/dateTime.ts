...
export function upMigration(legacyType: AbstractDataTypeConstructor, format: string, length: number) {
...
export const createDateTimeStringUpMigration = upMigration(DATE, ISO9075_DATETIME_FORMAT, ISO9075_DATETIME_FORMAT_LENGTH);
export const createDateStringUpMigration = upMigration(DATEONLY, ISO9075_DATE_FORMAT, ISO9075_DATE_FORMAT_LENGTH);
