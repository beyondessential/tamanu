...
module.exports = {
  ...
  down: async query => {
    ...
    await query.sequelize.query(
      ...
      SET status =
        CASE
          WHEN status = '${NEW_REPORT_REQUEST_STATUSES.RECEIVED_BY_FACILITY}' THEN '${OLD_REPORT_REQUEST_STATUSES.RECEIVED}'
          ...
          WHEN status = '${NEW_REPORT_REQUEST_STATUSES.PROCESSING_FINISHED}' THEN '${OLD_REPORT_REQUEST_STATUSES.PROCESSING}'
