// n.b. this whole migration is a direct copy of migration 131, with a single edit on line 22 (see
// original version on line 54)
  ...
  await query.sequelize.query(`
    CREATE OR REPLACE FUNCTION set_updated_at_by_field()
      ...
      BEGIN
        ...
        IF (OLD IS NULL AND NEW.updated_at_by_field IS NULL) THEN
