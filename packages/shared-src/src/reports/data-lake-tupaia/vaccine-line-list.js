...
const reportColumnTemplate = [
  ...
  { title: 'name', accessor: data => data.vaccineName },
  { title: 'category', accessor: data => data.category },
  { title: 'status', accessor: data => data.vaccineStatus },
  { title: 'schedule', accessor: data => data.schedule },
  { title: 'date', accessor: data => data.vaccineDate },
