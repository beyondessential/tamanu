...
export const MARITAL_STATUS_LABELS = {
  [MARITAL_STATUS_VALUES.DEFACTO]: 'De facto',
  [MARITAL_STATUS_VALUES.MARRIED]: 'Married',
  [MARITAL_STATUS_VALUES.SINGLE]: 'Single',
  [MARITAL_STATUS_VALUES.WIDOW]: 'Widow',
  [MARITAL_STATUS_VALUES.DIVORCED]: 'Divorced',
  [MARITAL_STATUS_VALUES.SEPARATED]: 'Separated',
  [MARITAL_STATUS_VALUES.UNKNOWN]: 'Unknown',
};

// TODO: used in BirthNotificationCertificate and can be removed once translations are implemented there
export const MARITAL_STATUS_OPTIONS = [
  {
    value: MARITAL_STATUS_VALUES.DEFACTO,
    label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.DEFACTO],
  },
  {
    value: MARITAL_STATUS_VALUES.MARRIED,
    label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.MARRIED],
  },
  {
    value: MARITAL_STATUS_VALUES.SINGLE,
    label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.SINGLE],
  },
  { value: MARITAL_STATUS_VALUES.WIDOW, label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.WIDOW] },
  {
    value: MARITAL_STATUS_VALUES.DIVORCED,
    label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.DIVORCED],
  },
  {
    value: MARITAL_STATUS_VALUES.SEPARATED,
    label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.SEPARATED],
  },
  {
    value: MARITAL_STATUS_VALUES.UNKNOWN,
    label: MARITAL_STATUS_LABELS[MARITAL_STATUS_VALUES.UNKNOWN],
  },
];
