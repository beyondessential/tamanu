...
const EXCLUDE_FROM_GENERAL_IMPORTABLE = [
  OTHER_REFERENCE_TYPES.PROGRAM_REGISTRY_CLINICAL_STATUS,
  OTHER_REFERENCE_TYPES.PROGRAM_REGISTRY_CONDITION,
  OTHER_REFERENCE_TYPES.PROGRAM_REGISTRY_CONDITION_CATEGORY,
];
...
export const GENERAL_IMPORTABLE_DATA_TYPES = [
  ...REFERENCE_TYPE_VALUES,
  ...OTHER_REFERENCE_TYPE_VALUES.filter((x) => !EXCLUDE_FROM_GENERAL_IMPORTABLE.includes(x)),
