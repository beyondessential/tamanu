...
export const INVOICE_INSURANCE_PLAN_PAYMENT_STATUSES = {
  UNPAID: 'unpaid',
  PAID: 'paid',
  PARTIAL: 'partial',
  REJECTED: 'rejected',
...
export const INVOICE_INSURANCE_PLAN_PAYMENT_STATUS_LABELS = {
  [INVOICE_INSURANCE_PLAN_PAYMENT_STATUSES.UNPAID]: 'Unpaid',
  [INVOICE_INSURANCE_PLAN_PAYMENT_STATUSES.PAID]: 'Paid',
  [INVOICE_INSURANCE_PLAN_PAYMENT_STATUSES.PARTIAL]: 'Partial',
  [INVOICE_INSURANCE_PLAN_PAYMENT_STATUSES.REJECTED]: 'Rejected',
};
