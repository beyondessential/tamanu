...
export const ATTENDANT_OF_BIRTH_OPTIONS = [
  { value: ATTENDANT_OF_BIRTH_TYPES.DOCTOR, label: ATTENDANT_OF_BIRTH_LABELS.DOCTOR },
  { value: ATTENDANT_OF_BIRTH_TYPES.MIDWIFE, label: ATTENDANT_OF_BIRTH_LABELS.MIDWIFE},
  { value: ATTENDANT_OF_BIRTH_TYPES.NURSE, label: ATTENDANT_OF_BIRTH_LABELS.NURSE },
  {
    value: ATTENDANT_OF_BIRTH_TYPES.TRADITIONAL_BIRTH_ATTENDANT,
    label: ATTENDANT_OF_BIRTH_LABELS.TRADITIONAL_BIRTH_ATTENDANT,
  },
  { value: ATTENDANT_OF_BIRTH_TYPES.OTHER, label: ATTENDANT_OF_BIRTH_LABELS.OTHER },
];
...
export const BIRTH_DELIVERY_TYPE_OPTIONS = [
  { value: BIRTH_DELIVERY_TYPES.NORMAL_VAGINAL_DELIVERY, label: BIRTH_DELIVERY_TYPE_LABELS.NORMAL_VAGINAL_DELIVERY },
  { value: BIRTH_DELIVERY_TYPES.BREECH, label: BIRTH_DELIVERY_TYPE_LABELS.BREECH },
  { value: BIRTH_DELIVERY_TYPES.EMERGENCY_C_SECTION, label: BIRTH_DELIVERY_TYPE_LABELS.EMERGENCY_C_SECTION },
  { value: BIRTH_DELIVERY_TYPES.ELECTIVE_C_SECTION, label: BIRTH_DELIVERY_TYPE_LABELS.ELECTIVE_C_SECTION },
  { value: BIRTH_DELIVERY_TYPES.VACUUM_EXTRACTION, label: BIRTH_DELIVERY_TYPE_LABELS.VACUUM_EXTRACTION },
  { value: BIRTH_DELIVERY_TYPES.FORCEPS, label: BIRTH_DELIVERY_TYPE_LABELS.FORCEPS },
  { value: BIRTH_DELIVERY_TYPES.OTHER, label: BIRTH_DELIVERY_TYPE_LABELS.OTHER },
];
...
export const BIRTH_TYPE_OPTIONS = [
  { value: BIRTH_TYPES.SINGLE, label: BIRTH_TYPE_LABELS.SINGLE },
  { value: BIRTH_TYPES.PLURAL, label: BIRTH_TYPE_LABELS.PLURAL },
];
...
export const PLACE_OF_BIRTH_OPTIONS = [
  { value: PLACE_OF_BIRTH_TYPES.HEALTH_FACILITY, label: PLACE_OF_BIRTH_LABELS.HEALTH_FACILITY },
  { value: PLACE_OF_BIRTH_TYPES.HOME, label: PLACE_OF_BIRTH_LABELS.HOME },
  { value: PLACE_OF_BIRTH_TYPES.OTHER, label: PLACE_OF_BIRTH_LABELS.OTHER },
];
