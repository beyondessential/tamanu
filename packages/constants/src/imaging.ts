...
export const IMAGING_TYPE_LABELS = {
  [IMAGING_TYPES.ANGIOGRAM]: 'Angiogram',
  [IMAGING_TYPES.COLONOSCOPY]: 'Colonoscopy',
  [IMAGING_TYPES.CT_SCAN]: 'CT Scan',
  [IMAGING_TYPES.ECG]: 'ECG',
  [IMAGING_TYPES.ECHOCARDIOGRAM]: 'Echocardiogram',
  [IMAGING_TYPES.ENDOSCOPY]: 'Endoscopy',
  [IMAGING_TYPES.FLUROSCOPY]: 'Fluroscopy',
  [IMAGING_TYPES.HOLTER_MONITOR]: 'Holter Monitor',
  [IMAGING_TYPES.MAMMOGRAM]: 'Mammogram',
  [IMAGING_TYPES.ORTHOPANTOMOGRAPHY]: 'Orthopantomography',
  [IMAGING_TYPES.MRI]: 'Mri',
  [IMAGING_TYPES.STRESS_TEST]: 'Stress Test',
  [IMAGING_TYPES.ULTRASOUND]: 'Ultrasound',
  [IMAGING_TYPES.VASCULAR_STUDY]: 'Vascular Study',
  [IMAGING_TYPES.X_RAY]: 'X-Ray',
};
