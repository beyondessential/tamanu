...
export const IMAGING_AREA_TYPES = {
  ...
  CR_IMAGING_AREA: 'crImagingArea',
  CT_SCAN_IMAGING_AREA: 'ctScanImagingArea',
  DX_IMAGING_AREA: 'dxImagingArea',
...
export const AREA_TYPE_TO_IMAGING_TYPE = {
  ...
  [IMAGING_AREA_TYPES.CR_IMAGING_AREA]: IMAGING_TYPES.CR,
  [IMAGING_AREA_TYPES.DX_IMAGING_AREA]: IMAGING_TYPES.DX,
