...
export const IMAGING_AREA_TYPES = {
  ...
  MAMMOGRAM_SCREENING_IMAGING_AREA: 'mammogramScreeningImagingArea',
  MAMMOGRAM_DIAGNOSTIC_IMAGING_AREA: 'mammogramDiagnosticImagingArea',
...
export const IMAGING_TYPES = {
  ...
  MAMMOGRAM: 'mammogram',
  MAMMOGRAM_SCREENING: 'mammogram_screening',
  MAMMOGRAM_DIAGNOSTIC: 'mammogram_diagnostic',
...
export const AREA_TYPE_TO_IMAGING_TYPE = {
  ...
  [IMAGING_AREA_TYPES.MAMMOGRAM_SCREENING_IMAGING_AREA]: IMAGING_TYPES.MAMMOGRAM_SCREENING,
  [IMAGING_AREA_TYPES.MAMMOGRAM_DIAGNOSTIC_IMAGING_AREA]: IMAGING_TYPES.MAMMOGRAM_DIAGNOSTIC,
