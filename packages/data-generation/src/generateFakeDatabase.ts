...
// TODO: maybe this should come to this package too?
const { fake } = require('@tamanu/shared/test-helpers/fake');

// Functions for creating groupings of related data
const createFacilityData = async ({
  ...
  return { locationGroup, location, facility, department };
};
...
const createDbReportData = async (
...
const createImagingRequestData = async (
...
const createLabRequestData = async (
...
const createUserData = async ({ User, UserPreference }: Models) => {
