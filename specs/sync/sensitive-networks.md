...
- [ ] A sensitive network is identified by an id and carries a name, which is required.
...
- [ ] Each of those networks takes the name of its facility, which an administrator can rename through the reference data import.
