...
- **Lab request view (encounter level):**
  ...
  - Display individual tests first alphabetically after panels., alphabetically and within each panel display tests in the same order as listed in reference data.
