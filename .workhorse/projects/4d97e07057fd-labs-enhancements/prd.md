...
| # | Card | Feature | Design work | Status |
|---|------|---------|-------------|--------|
| 1 | TAM-2053 | Combined test & panel ordering workflow, with panel contents visible and duplicates prevented | **Yes** — new ordering workflow | Detailed — 1 open question |
| 2 | _TBC_ | _Awaiting card_ | _TBC_ | Not yet added |
| 3 | TAM-2045 | Specimen type shown next to sample collected date & time | **Minimal** — surface an existing field on the tile | Detailed |
