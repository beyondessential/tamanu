...
- **Strategic sizing note.** The field is desktop-first via the  device; mobile is used mainly by phone-only staff without tablets. How big the mobile-sync prize is depends on how many are actually on mobile — and their "make mobile usable in the field" ask routes through the Iti-connectivity question as much as raw performance.