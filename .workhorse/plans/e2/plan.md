...
- [x] Configurable store root (`blobStorage.root` setting, central + facility scoped, default `data/blobs`) + free-disk reserve (global setting `blobStorage.freeDiskReserveGB`)
